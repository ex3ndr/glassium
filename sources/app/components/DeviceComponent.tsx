...
export const DeviceComponent = React.memo((props: { kind: 'compass' | 'friend' | 'bubble', title: string, subtitle: string, onPress?: () => void }) => {
    return (
        <Pressable style={(p) => ({ backgroundColor: p.pressed ? '#111111' : '#1c1c1c', alignSelf: 'stretch', height: 86, borderRadius: 16, alignItems: 'center', paddingHorizontal: 16, flexDirection: 'row' })} onPress={props.onPress}>
